...
<button class="layui-btn layui-btn-sm abc" onclick="query()">查询</button>
  </div>
...
table.render({
  ...
  ,url:'<%=basePath%>courseController/query/queryClassroom?cId='+cId+'&cName='+cName+'&cClassRoom='+cClassRoom
...
layui.use('table', function(){
  ...
  ,url:"<%=basePath%>courseController/query/queryClassroom"
    ,toolbar: '#toolbarDemo' //开启头部工具栏，并为其绑定左侧模板
    ,defaultToolbar: ['filter', 'exports', 'print', { //自定义头部工具栏右侧图标。如无需自定义，去除该参数即可
      title: '提示'
      ,layEvent: 'LAYTABLE_TIPS'
