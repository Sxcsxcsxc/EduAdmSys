...
layui.use('table', function(){
  ...
  ,url:"<%=basePath%>attendanceController/query/AllByPage"
    ...
    ,cols: [[
             ...
             /* ,{field:'roleId', title:'角色', width:80, templet:function(res){
            	 var role;
            	 if(res.user.role.rid==3){
            		 role = "讲师";
            	 }else if(res.user.role.rid==4){
            		 role = "学生";
            	 }
                 return '<em>'+  
                 role
