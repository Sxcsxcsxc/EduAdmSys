...
layui.use('table', function(){
  ...
  ,url:"<%=basePath%>user/query/queryAllTest"
    ...
    ,cols: [[
      ...
      ,{field:'uUsername', title:'用户名', width:120, edit: 'text'}
      ,{field:'uPassword', title:'密码', width:80, edit: 'text', sort: true}
      ,{field:'uRealname', title:'真实姓名', width:100}
      ,{field:'uState', title:'盐'}
