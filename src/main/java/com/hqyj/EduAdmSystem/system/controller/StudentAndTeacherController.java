...
//		System.err.println("-----user---维护好的page-----queryAllUserListByPage()---page：" + page);
    ...
    @ResponseBody
    public int updateUserByUserForCU(UserForCU userForCU_ui, String[] userForCUListId, HttpSession session) {
        int count = 0;
...
//		userForCU_ui.setuRealPW(userForCU_ui.getuPassword());
        ...
        while (count > 0) {
            User user = userService.findUserByName(userForCU_ui.getuUsername());
